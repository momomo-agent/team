...
class RuntimeInterface {
  ...
  /** Read a task by directory name. Returns task object or null. */
  readTask(taskDir) { throw new Error('not implemented'); }

  /** Update task fields. Returns updated task or null. */
  updateTaskFields(taskDir, updates) { throw new Error('not implemented'); }

  /** List task directory names. Returns string[]. */
  listTaskDirs() { throw new Error('not implemented'); }

  /** Check if a file exists in a task directory. */
  taskFileExists(taskDir, filename) { throw new Error('not implemented'); }

  /** Read a file from a task directory. Returns string or null. */
  readTaskFile(taskDir, filename) { throw new Error('not implemented'); }

  /** List CR filenames. Returns string[]. */
  listCRFiles() { throw new Error('not implemented'); }

  /** Read a CR file. Returns object or null. */
  readCRFile(filename) { throw new Error('not implemented'); }

  /** Update a CR file. Returns updated object or null. */
  updateCRFile(filename, updates) { throw new Error('not implemented'); }

  /** Read a gap analysis file. Returns object or null. */
  readGap(name) { throw new Error('not implemented'); }

  /** Check if a file exists relative to projectDir. */
  fileExists(relativePath) { throw new Error('not implemented'); }
